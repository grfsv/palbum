...
CREATE TABLE `friend_codes` (
  ...
  UNIQUE INDEX `idx_friend_codes_code` (`code`)
) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
CREATE TABLE `friend_requests` (
  ...
  UNIQUE INDEX `idx_friend` (`sender_uuid`, `receiver_uuid`),
  INDEX `idx_friend_requests_request_uuid` (`request_uuid`)
) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- Create "friendships" table
CREATE TABLE `friendships` (
  `friendship_uuid` char(36) NOT NULL,
  `user_uuid` char(36) NOT NULL,
  `friend_uuid` char(36) NOT NULL,
  `accepted_at` datetime(3) NOT NULL,
  PRIMARY KEY (`friendship_uuid`, `user_uuid`, `friend_uuid`),
  INDEX `idx_friendships_user_uuid` (`user_uuid`)
) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- Create "users" table
CREATE TABLE `users` (
  `uuid` char(36) NOT NULL,
